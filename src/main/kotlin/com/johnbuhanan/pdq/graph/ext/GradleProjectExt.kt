package com.johnbuhanan.pdq.graph.ext

import com.johnbuhanan.pdq.graph.model.GradleProject
 ...
 * .api.commonThing -> /User/someuser/repo/api/common-thing
 */
fun String.toAbsolutePath(root: Path): Path {
...
fun String.toGradleProject(): GradleProject {
    return GradleProject(toProjectPath())
}
